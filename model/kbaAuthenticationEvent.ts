...
export class KbaAuthenticationEvent {
    'object'?: string | null;
    'documentId'?: string | null;
    'messageTitle'?: string | null;
    'documentDescription'?: string | null;
    'status'?: KbaAuthenticationEvent.StatusEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "status",
            "baseName": "status",
            "type": "KbaAuthenticationEvent.StatusEnum"
        },
        {
            "name": "senderDetail",
    ...
    static getAttributeTypeMap() {
        return KbaAuthenticationEvent.attributeTypeMap;
    }
}

export namespace KbaAuthenticationEvent {
